<div class="box box-primary">
	...
	<div class="box-body">
		<div class="col-md-12">
			<?= form_open('statistik/table3/tambah'); ?>
			<table class="table table-striped">
				...
				<tr>
					...
					<td><input type="number"  class="form-control" name="pra_s"></td>
					<td><input type="number"  class="form-control" name="ks_I"></td>
					<td><input type="number"  class="form-control" name="ks_II_III"></td>
					<td><input type="submit"  class="btn btn-primary" name="aksi" value="Tambah"></td>
				</tr>
			</table>
			<?= form_close(); ?>
		</div>		
