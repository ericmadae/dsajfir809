<div class="box box-primary">
	...
	<div class="box-body">
		<div class="col-md-6">
			<?= form_open('statistik/table1/ubahdata'); ?>
			<div class="form-gorup">
				<label for="Desa">Desa/kelurahan</label>
				<input type="hidden" name="id" value="<?= $info['id'] ?>">
				<input type="text" class="form-control" name="desa_kelurahan" value="<?= $info['desa_kelurahan'] ?>">
			</div>
			<div class="form-gorup">
				<label for="Desa">Laki-laki</label>
				<input type="number" class="form-control" name="laki_laki" value="<?= $info['laki_laki'] ?>">
			</div>
			<div class="form-gorup">
				<label for="Desa">Perempuan</label>
				<input type="number" class="form-control" name="perempuan" value="<?= $info['perempuan'] ?>">
			</div>
			<br>
			<div class="form-gorup">
				<input type="submit" class="btn btn-success pull-right" value="ubah">
				<a href="<?= base_url('table1') ?>" class="btn btn-primary" >Kembali</a>
