<div class="box box-primary">
	...
	<div class="box-body">
		<div class="col-md-12">
			<?= form_open('statistik/table2/tambah'); ?>
			<table class="table table-striped">
				...
				<tr>
					...
					<td><input type="number"  step="0.01" class="form-control" name="luas"></td>
					<td><input type="number"  step="0.01" class="form-control" name="sawah"></td>
					<td><input type="number" step="0.01"  class="form-control" name="ladang"></td>
					<td><input type="number" step="0.01"  class="form-control" name="rumah"></td>
					<td><input type="number" step="0.01"  class="form-control" name="lainnya"></td>
					<td><input type="submit"  step="0.01" class="btn btn-primary" name="aksi" value="Tambah"></td>
				</tr>
			</table>
			<?= form_close(); ?>
		</div>		
